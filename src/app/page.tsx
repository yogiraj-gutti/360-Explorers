...
export default function Home() {
  ...
  const internationalAdventures = adventures.filter(a => a.currency === 'USD');
  const allAdventures = [...featuredAdventures, ...internationalAdventures].filter((adventure, index, array) => 
    index === array.findIndex(a => a.id === adventure.id)
  ).slice(0, 14);
