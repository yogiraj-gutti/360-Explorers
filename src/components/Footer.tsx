    ...
    <footer className="bg-[#081120] text-[#F8FAFC] w-full border-t border-white/5 font-sans">
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          {/* Contact Info */}
          <div className="lg:border-l border-white/10 lg:pl-12 space-y-3 text-right">
            ...
            <div className="flex flex-col items-end gap-1 pt-2">
              <a href="tel:+917770000206" className="text-lg font-bold text-white hover:text-[#14B8A6] transition-colors">
                +91-7770000206
              </a>
              <a href="tel:+917770000205" className="text-lg font-bold text-white hover:text-[#14B8A6] transition-colors">
                +91-7770000205
              </a>
              <a href="mailto:contact@example.com" className="text-gray-400 text-sm hover:text-[#14B8A6] transition-colors mt-1">
                contact@example.com
              </a>
            </div>
          </div>
        ...
        <div className="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            {[Globe, Camera, Send, Mail].map((Icon, i) => (
              <a key={i} href="#" className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#14B8A6] hover:text-white hover:border-[#14B8A6] transition-all">
                <Icon size={14} />
              </a>
            ))}
          </div>
